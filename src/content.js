module.exports = {
	skills: [
		...
		{
			title: "Tools",
			entries: ["Bash/ZSH", "Git & GitHub", "Photoshop", "Figma", "Sony Vegas Pro"],
		},
	],
	...
	jobs: [
		{
			...
			responsibilities: [
				...
				"Designed and built new society website from scratch, using React (and Gatsby).",
			],
		},
		{
			name: "Rewind Gaming",
			...
			startDate: "Jun 2016",
			endDate: "Nov 2019",
			url: "https://twitter.com/rewindrl",
			responsibilities: [
		...
		},
		{
			...
			startDate: "Aug 2017",
			endDate: "Sept 2017",
			url: "https://www.ncsc.gov.uk/information/cyberfirst",
			responsibilities: [
